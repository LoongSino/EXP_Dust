...
from resnet.model.enlarge_feature_map import resnet50_efm
...
# 加载预训练的ResNet50模型
model = resnet50_efm(num_classes=4)
...
def train_model(model, criterion, optimizer, num_epochs):
    ...
    # 保存损失图
    plt.savefig('../performance/efm_loss.png')
    plt.show()
    ...
    # 保存准确率图
    plt.savefig('../performance/efm_acc.png')
    plt.show()
...
if __name__ == '__main__':
    ...
    # 保存训练好的模型
    torch.save(model_trained.state_dict(), '../checkpoints/resnet50_efm_dust.pth')
